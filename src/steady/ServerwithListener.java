...
public class ServerwithListener {
	...
	public static void reveivePic() throws ClassNotFoundException, IOException{
		...
		FileOutputStream FOS = new FileOutputStream("/home/wy/Documents/romate/"+g.getFileName());
		FOS.write(g.getFileContent(),0,(int)g.getFileLength());
		FOS.flush();
		
		FileInputStream FIS= new FileInputStream("/home/wy/Documents/romate/"+g.getFileName());
